 ...
 *
 * Synchronized serializes access for what is locked and guarantee memory
 * visibility for the changes that happened inside the synchronized scope to all threads
 *
 * Intrinsic locks are reentrant: if you are holding it, you can acquire it again,without deadlocking
 */
public class UsingIntrinsicLocks {
    ...
    public void mySynchronizedBlock(){
         ...
         * lock.The message bellow will be printed before the message inside the synchronized block
         */
