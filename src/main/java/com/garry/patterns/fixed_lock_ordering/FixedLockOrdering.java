package com.garry.patterns.fixed_lock_ordering;
 ...
 *
 * Intent: Create a fixed-ordered locking mechanism to prevent possibles deadlocks.
 * We define a value to the locks objects and use comparisons to establish
 * a fixed order bases on who is greater or lesser.
 *
