package com.garry.patterns.task_cancel;
 ...
 * thread state and keep it running or not
 *
...
public class ThreadTaskCancel {
    ...
    public Runnable task = () -> {
        ...
        {
            // keep going - be aware of using this Pattern with the Interrupted exceptions! It won't work
        }
    };
