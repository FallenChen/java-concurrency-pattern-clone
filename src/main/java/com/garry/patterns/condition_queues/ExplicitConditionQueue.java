package com.garry.patterns.condition_queues;
 ...
 * Condition Queue help us to identify the condition predicates and do control
 * to programming flux associated with it.Also, wait/notify are based in intrinsic lock mechanisms
 *
 * Intent: Create a Condition Queue mechanism based on the capabilities of
 * the Lock interface to generate Conditions.
 *
