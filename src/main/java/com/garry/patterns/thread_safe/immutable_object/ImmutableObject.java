package com.garry.patterns.thread_safe.immutable_object;
 ...
 * state object, lost updates, stale values and others. An Immutable objects is
 ...
 * internal state of the object; don't expose the object until it's full created;
 * make the class final, prohibiting extension.It's important to refer to an immutable
 * object using a volatile field, because it has visibility guarantees (every change to the
 * immutable object variable will be made visible to all threads),and any synchronizing mechanism
 * to ensure thread-safety for the reference.
 *
 * Applicability: When sharing a object, use Immutable Objects being referenced by a volatile fields
...
public class ImmutableObject {
    ...
    public final static class MyImmutableObject {
        ...
        public final boolean anotherValue;
