 ...
 * allows the execution to be parallel, possible the increasing the speed if
 * those problems were difficult enough to compensate the cost involved in parallelization
 *
