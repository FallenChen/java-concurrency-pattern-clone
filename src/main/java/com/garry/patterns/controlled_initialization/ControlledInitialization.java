package com.garry.patterns.controlled_initialization;
 ...
 *
 * Intent: Use CountDownLatch to create a controlled concurrent initialization mechanism
 *
 * Applicability: When you have multiple expensive resources being initialized concurrently
 *
 */
